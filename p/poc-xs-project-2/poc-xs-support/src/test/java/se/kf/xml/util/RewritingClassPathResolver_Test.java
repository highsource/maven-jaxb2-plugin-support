...
public class RewritingClassPathResolver_Test {
	...
	public void test_systemId_http() {
		...
		AbstractClassPathResolver resolver = new RewritingClassPathResolver("http://kfm.se/poc/");
		...
		verify(loader).getResourceAsStream(eq("/schemas/common/MySchema.xsd"));
	...
	public void test_systemId_file_remote() {
		...
		AbstractClassPathResolver resolver = new RewritingClassPathResolver(prefixes);
		resolver.setSchemaLoader(loader);
