 ...
 *       &lt;sequence&gt;
 *         &lt;element name="campaign" type="{http://bird.kartaca.com/xmlschema/admin/delivery}Campaign"/&gt;
...
@XmlRootElement(name = "sendCampaignRequest", namespace = "http://bird.kartaca.com/xmlschema/admin/delivery")
public class SendCampaignRequest {
     ...
     *     
     */
    public void setCampaign(CampaignDto value) {
        this.campaign = value;
    }
